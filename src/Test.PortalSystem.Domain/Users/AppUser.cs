...
namespace Test.PortalSystem.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update PortalSystemDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update PortalSystemEfCoreEntityExtensionMappings to extend the IdentityUser entity
